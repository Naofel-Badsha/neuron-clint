...
const Login = () => {
  ...
  const eyeIconClassNameopen = pass
    ? "text-xl absolute top-3 right-4  hidden"
    : "text-xl absolute top-3 right-4 cursor-pointer";
  const eyeIconClassNameclos = pass
    ? "text-xl absolute top-3 right-4 cursor-pointer"
    : "text-xl absolute top-3 right-4 hidden";
        ...
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl border  font-sans mx-auto border-custom-bg">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-5 ">
              ...
              <input
                ...
                name="email"
                placeholder="Email"
                className="w-full text-xl border-b-[2px] py-1 text-black bg-transparent outline-none placeholder:italic focus:outline-none "
              />
              {errors.email && (
              ...
              <div className="space-y-2 ">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full text-xl border-b-[2px] py-1 bg-transparent outline-none placeholder:italic focus:outline-none "
                  />
                  <div className="flex items-center justify-center absolute right-0 -mt-10">
                    {errors.password && (
                    ...
                    <FaRegEyeSlash 
                      onClick={togglepass}
                      className={eyeIconClassNameclos}
                    />
                    <FaRegEye
                      onClick={togglepasstr}
                      className={eyeIconClassNameopen}
                    />
                  </div>
            ...
            <button className="text-2xl rounded-xl relative p-[10px] block w-full bg-custom-bg text-white border-y-4 duration-500 overflow-hidden focus:border-custom-bg z-50 group">
              Log In
          ...
          <div className="flex justify-center space-x-4">
            <button
              ...
              type="button"
              className="flex items-center justify-center w-full p-3 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-custom-bg"
            >
              <svg
          ...
          <div className="flex gap-2 items-center justify-center">
            <div className="text-sm text-center">Dont have an account?</div>
            <Link
              to="/Rejistition"
