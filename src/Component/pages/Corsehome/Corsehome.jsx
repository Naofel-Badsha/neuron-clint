  ...
  if (isLoading) {
    return (
      <div className="">
        ...
        <h2 className="text-center  md:text-4xl font-bold">আমাদের <span className="text-custom-bg">কোর্সসমূহ</span> </h2>
        </div>
  ...
  return (
    <div className="pt-10 pb-10">
      <div className=""   >
        ...
        <h2 className="text-center text-4xl md:text-5xl font-bold">আমাদের <span className="text-custom-bg">কোর্সসমূহ</span> </h2>
        </div>
      </div>
      <div className=" grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 p-2">
