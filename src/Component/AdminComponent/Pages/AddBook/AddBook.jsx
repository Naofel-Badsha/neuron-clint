...
const AddBook = () => {
    ...
    if (showName) {
      ...
      try {
        ...
        if (imgbbResponse.data.success) {
          ...
          const response = await fetch(`${import.meta.env.VITE_API_URL}/Add/books`, {
            method: 'POST',
            headers: {
      ...
      <input ref={fileInputRef} onChange={(e) => {
        ...
        {/* <div>
          ...
          />
           ...
           <div>
          <label className="block mb-2">বইয়ের নাম </label>
          <input
            type="text"
        ...
        <div>
          <label className="block mb-2">মূল্য :</label>
          <input
            type="text"
 ...
 <div>
  ...
  >
    ...
    <option value="admission">এডমিশন বই</option>
    <option value="akadami">একাডেমিক বই</option>
    <option value="niyog">নিয়োগ বই</option>
  </select>
</div>
