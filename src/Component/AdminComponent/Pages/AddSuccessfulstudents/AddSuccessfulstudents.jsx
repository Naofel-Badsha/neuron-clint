...
const AddSuccessfulstudents = () => {
    ...
    if (showName) {
      ...
      try {
        ...
        if (imgbbResponse.data.success) {
          ...
          const response = await fetch(`${import.meta.env.VITE_API_URL}/Add/Successfulstudents`, {
            method: 'POST',
            headers: {
  ...
  return (
    <div className="container mx-auto my-8 p-4">
      <h1 className="text-3xl mb-4">Add Book</h1>
      ...
      <input ref={fileInputRef} onChange={(e) => {
        ...
        {/* <div>
          ...
          />
           ...
           <div>
          <label className="block mb-2"> student নাম </label>
          <input
            type="text"
        ...
        <div>
          <label className="block mb-2"> Secession:</label>
          <input
            type="text"
            {...register('Secession', { required: true })}
            className="w-full p-2 border border-gray-300 rounded"
          />
        </div>
        ...
        <div>
          <label className="block mb-2"> institutions:</label>
          <input
            type="text"
            {...register('institutions', { required: true })}
            className="w-full p-2 border border-gray-300 rounded"
          />
        </div>
