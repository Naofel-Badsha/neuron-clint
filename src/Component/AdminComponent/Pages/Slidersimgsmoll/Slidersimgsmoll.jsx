...
import { Modaladdimgsmall } from '../../../Modals/Modaladdimgsmall/Modaladdimgsmall';
...
const Slidersimgsmoll = () => {
    ...
    const { data: images = [], isLoading, refetch } = useQuery({
      queryKey: ['slidersimgsmoll'],
      queryFn: async () => {
        const { data } = await AxiosCommon(`/slidersimgsmoll`);
        return data;
      },
    });
    ...
    const handleDelete = () => {
        AxiosCommon.delete(`/slidersimgsmoll/${itemToDelete}`)
            .then((res) => {
                refetch();
    ...
    return (
        <div>
            {images.map((data, idx) => (
                <div key={idx} className="flex gap-7 mt-6">
                    ...
                    <div className="flex gap-5 items-center">
                       {/* <Link to={`slidersimgsmoll/singledata/update/${data._id}`}> <button
            ...
            <Modaladdimgsmall openModal={openModal} setOpenModal={setOpenModal} refetch={refetch} />
...
export default Slidersimgsmoll;
