...
const Footer = () => {
    return (
<footer className="w-full bg-[#4d386b] mt-4 ">
        <div className="mx-auto  px-4 sm:px-6 lg:px-8 max-w-screen-xl mx-auto">
           
            <div className="grid grid-cols-12 gap-8 py-14 lg:grid-cols-7    ">
       ...
       <div className=" flex items-center gap-2">
        ...
        <div className="">
       <p className="tracking-wider text-4xl font-bold  bg-clip-text text-transparent bg-custom-bg">NEURON</p>
       <p className='tracking-tight text-xs font-medium text-white'> Nursing Admission Coaching</p>
       </div>
       </div>
                    <p className="py-8  text-white lg:max-w-xs text-center lg:text-left"></p>
                    <div className="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
                
                        <a   className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-gray-900 to-gray-900  
                        ">
                      ...
                      <a   className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-custom-bg  hover:bg-gray-900 ">
                ...
                <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                    <h4 className="text-lg text-white font-medium mb-7">Get In Touch</h4>
                    <ul className="text-white  transition-all duration-500">
                       
                       
                        <li className="flex gap-3 mt-4" > <FaPhoneAlt className="text-lg"/> +88 01730577236 </li>
                        <li className="flex gap-3 mt-4" > <MdEmail  className="text-xl"/>  neuronnursing32@gmail.com</li>
                        <li className="flex gap-3 mt-4" > <TbWorld  className="text-xl"/> https://neuronnursingcoaching.com/ </li>
                        <li className="flex gap-3 mt-4 text-left" > <IoLocationSharp  className="text-4xl"/> ৯৫ গ্রীনরোড, বিটিআই সেন্ট্রাল প্লাজা, ৩য় তলা (লিফটের-২), আনন্দ সিনেমা হলের বিপরীতে </li>
                ...
                <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-1">
                    ...
                    <ul className="text-white transition-all duration-500  flex flex-col ">
                        ...
                        <Link to={"/"} className="mb-6"><a   className=" text-white hover:text-white">হোম</a></Link>
                        <Link to={"/AllCorsess"} className="mb-6"><a   className=" text-white hover:text-white">কোর্সসমূহ</a></Link>
                        <Link to={"/AboutUs"} className="mb-6"><a   className=" text-white hover:text-white">আমাদেরসম্পর্কে</a></Link>
                        <Link to={"/Allbranch"} className="mb-6"><a   className=" text-white hover:text-white"> শাখাসমূহ</a></Link>
                ...
                <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                    <h4 className="text-lg text-center text-white font-medium mb-7 lg:text-left">Newsletter</h4>
                    <div className="flex flex-col items-center lg:items-start">
                        <input type="text" className="w-full  border border-gray-300 rounded-full py-2.5 px-5 shadow-sm text-gray-800 mb-5 text-center lg:text-left placeholder:text-gray-400 focus:outline-none focus:border-gray-500"  placeholder="Your email here.."/>
                        <button type="submit" className=" py-3 px-6 bg-custom-bg transition-all duration-500 shadow-md rounded-full text-sm text-white font-semibold w-fit hover:bg-custom-bg">Subscribe</button>
                    </div>
                </div>
            ...
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-white "><div className="flex">
    <p>&copy; 1998 NEURON All rights reserved.</p>
    <p>Developed by <a href="https://web.facebook.com/fred.jh.31" target="_blank">Zobayer</a></p>
</div></span>
                    <ul className="flex items-center gap-9 mt-4 lg:mt-0">
                        <li><a   className="text-sm text-white">Terms</a></li>
                        <li><a   className="text-sm text-white">Privacy</a></li>
                        <li><a   className="text-sm text-white">Cookies</a></li>
                    </ul>
                </div>
            </div>
        </div>
