...
const Navbar = () => {
  ...
  // bg-white sticky inset-0 z-10 top-0 w-full max-w-full rounded-none border  bg-opacity-30 py-2 px-4 text-black shadow-md backdrop-blur-2xl backdrop-saturate-200 lg:px-2 lg:py-2
  return (
    <>
      <UpNavbar></UpNavbar>
      <div className="flex items-center justify-between  max-w-screen-xl mx-auto py-4 banglahed">
        {/*-------Navbar-------start-------*/}
