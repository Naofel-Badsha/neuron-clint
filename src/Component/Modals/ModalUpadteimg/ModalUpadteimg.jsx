...
export const ModalUpdateImg = ({
  ...
  const onSubmit = async (event) => {
    ...
    if (showNameu.name) {
      ...
      try {
        ...
        try {
          const response = await AxiosCommon.put(`/updateimg/${data._id}`, {
            image: imageUrl,
          });
  ...
  return (
    <div className="mx-auto flex w-72 items-center justify-center">
      <div
        onClick={() => setOpenModalu(false)}
        className={`fixed z-[100] flex items-center justify-center ${
          openModalu ? "opacity-1 visible" : "invisible opacity-0"
              ...
              <div className=" mx-auto flex max-w-[600px] items-center gap-x-6  rounded-lg border-2 border-dashed border-gray-400 p-5 bg-white">
                ...
                <div className="flex-1 space-y-1.5 overflow-hidden">
                  ...
                  <p className="text-gray-500">
                    {(showNameu.size / 1024).toFixed(1)} KB
                  </p>
                </div>
